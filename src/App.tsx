    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      ...
      {!difficulty ? (
        ...
        <main className="flex-1 flex flex-col p-4 overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-4 flex-1">
          ...
          <div className="flex gap-2 items-center justify-center">
            {gameOver ? (
              <button
                onClick={restartGame}
                className="w-full max-w-[200px] bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2"
              >
